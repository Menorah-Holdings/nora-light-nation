...
export const queryKeys = {
  ...
  creators: {
    ...
    myFollowing: (query?: ListLiveEventsQuery) => [...queryKeys.creators.all, "me", "following", query ?? {}] as const,
    myProfile: () => [...queryKeys.creators.all, "me", "profile"] as const,
    myAnalytics: () => [...queryKeys.creators.all, "me", "analytics"] as const,
    myAnalyticsDaily: (range?: string) => [...queryKeys.creators.all, "me", "analytics", "daily", range ?? "30d"] as const,
  ...
  admin: {
    ...
    userDetail: (id: string) => [...queryKeys.admin.all, "users", "detail", id] as const,
    ...
    live: (query?: Record<string, unknown>) => [...queryKeys.admin.all, "live", query ?? {}] as const,
    reports: (query?: Record<string, unknown>) => [...queryKeys.admin.all, "reports", query ?? {}] as const,
    analytics: () => [...queryKeys.admin.all, "analytics"] as const,
    languages: () => [...queryKeys.admin.all, "settings", "languages"] as const,
    regions: () => [...queryKeys.admin.all, "settings", "regions"] as const,
    notificationTemplates: () => [...queryKeys.admin.all, "settings", "notification-templates"] as const,
    guideline: (type: string) => [...queryKeys.admin.all, "settings", "guidelines", type] as const,
    announcements: () => [...queryKeys.admin.all, "settings", "announcements"] as const,
    analyticsDaily: (range?: string) => [...queryKeys.admin.all, "analytics", "daily", range ?? "30d"] as const,
  },
};
