    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="flex items-center justify-between">
          <Logo />
          <button type="button" className="md:hidden text-muted-foreground" onClick={() => setOpen(false)}>
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="mt-10 rounded-xl bg-card-gradient p-4 ring-1 ring-border/60">
          ...
          <NavLink to="/partner" className="mt-3 inline-flex text-xs text-gold hover:underline">
            Learn more -&gt;
          </NavLink>
        </div>
        <button
          ...
          className="mt-4 flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-sm text-muted-foreground transition-colors hover:bg-sidebar-accent/60 hover:text-gold md:hidden"
        >
      ...
      <div className="md:pl-64">
        <header className="sticky top-0 z-30 flex items-center gap-3 border-b border-border bg-background/80 px-4 py-3 backdrop-blur-xl md:px-8 justify-between">
          ...
          <div className="flex space-x-4">
            ...
            <NavLink
              ...
              className="hidden h-9 w-9 items-center justify-center rounded-full bg-gold-gradient text-sm font-semibold text-primary-foreground ring-1 ring-gold/40 transition-shadow hover:shadow-glow sm:flex"
            >
              {user.avatarInitial}
            </NavLink>
            <button
              ...
              onClick={handleSignOut}
              aria-label="Sign out"
              className="hidden h-9 w-9 items-center justify-center rounded-full border border-border bg-secondary/50 text-muted-foreground transition-colors hover:border-gold/40 hover:text-gold sm:inline-flex"
            >
              <LogOut className="h-4 w-4" />
            </button>
          </div>
