  ...
  <div className="space-y-10">
    <div className="flex flex-wrap items-end justify-between gap-4">
      <div>
        ...
        <h1 className="mt-2 font-display text-4xl md:text-5xl">Creator Dashboard</h1>
        <p className="mt-2 text-muted-foreground">Manage your content, profile, and live events.</p>
      </div>
