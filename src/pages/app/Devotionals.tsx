  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-3xl bg-card-gradient ring-1 ring-gold/20 shadow-elegant p-8 md:p-12">
        ...
        <button className="mt-6 inline-flex items-center gap-2 rounded-full bg-gold-gradient px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-glow">Listen now</button>
      </div>
